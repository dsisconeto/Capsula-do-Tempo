...
{if !$isMobile}
    <div class="row margin-bottom-20 hidden-xs hidden-sm">
        ...
        <div class="col-md-12">
            ...
            <a href="/empresas/pesquisar/?arg=Hospedagem{if isset($geoRegionId)}&region={$geoRegionId}{/if}" class="segment-icon">
                <img src="/img/company-segment-02.png" class="img-responsive center-block">
                <p>Hospedagem</p>
            </a>

            <a href="/empresas/pesquisar/?arg=Diversão{if isset($geoRegionId)}&region={$geoRegionId}{/if}" class="segment-icon">
                <img src="/img/company-segment-04.png" class="img-responsive center-block">
                <p>Diversão</p>
            </a>

            <a href="/empresas/pesquisar/?arg=Imobiliárias{if isset($geoRegionId)}&region={$geoRegionId}{/if}" class="segment-icon">
                <img src="/img/company-segment-05.png" class="img-responsive center-block">
                <p>Imobiliárias</p>
            </a>

            <a href="/empresas/pesquisar/?arg=Farmácias+e+Drograrias{if isset($geoRegionId)}&region={$geoRegionId}{/if}" class="segment-icon">
                <img src="/img/company-segment-06.png" class="img-responsive center-block">
                <p>Farmácias e <br> Drograrias</p>
            </a>

            <a href="/empresas/pesquisar/?arg=Supermercados{if isset($geoRegionId)}&region={$geoRegionId}{/if}" class="segment-icon">
                <img src="/img/company-segment-07.png" class="img-responsive center-block">
                <p>Supermercados</p>
            </a>


            <a href="/empresas/pesquisar/?arg=Roupas+e+Calçados{if isset($geoRegionId)}&region={$geoRegionId}{/if}" class="segment-icon">

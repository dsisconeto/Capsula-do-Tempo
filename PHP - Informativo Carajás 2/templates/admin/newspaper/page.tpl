...
<link href="/css/page/newspaper/page.css" rel="stylesheet">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-header">
                        ...
                        <div class="btn-group  btn-group-sm pull-left">
                            ...
                            <a href="/impresso/editar/{$newspaperId}/" class="btn btn-info">
                                Editar Jornal
                            </a>
                        </div>
                    ...
                    <div class="box-body pad">
                        ...
                        <form role="form" id="form_newspaper_manager" method="post"
                              autocomplete="off" action="/form/impresso/paginas/upload/">
...
<script src="/js/page/newspaper/page.js"></script>

...
{block name="script" prepend}
    ...
    <script src="/dist_admin/js/obj/Newspaper.js"></script>

    <!-- script de configuração da pagina -->
    <script src="/dist_admin/js/page/newspaper/displayTable.js"></script>
    {if !$geoRegionId}
        <script>
            $("#geo_region_id").select2({

                ajax: {
                    url: "/services/regiao/select2/permissao/newspaper/",
                    dataType: 'json',
                    delay: 250,
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-header">
                            ...
                            <div class="btn-group  btn-group-sm pull-left">
                                <a href="/impresso/cadastrar/" class="btn btn-info">
                                    Cadastrar Jornal
                                </a>
                        ...
                        <div class="box-body pad">
                            <form method="get" action="/services/impresso/pesquisar/" id="form_newspaper">
                                {if $geoRegionId}

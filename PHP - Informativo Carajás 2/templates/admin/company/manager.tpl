...
{block name="script" prepend}
    ...
    <script src="/dist_admin/js/page/company/manager.js"></script>
    <script>
        companyLevel();
    </script>
{/block}
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <div class="btn-group pull-left">
                                ...
                                <a href="/admin/empresa/todas/" class="btn btn-info">
                        ...
                        <div class="box-body pad">
                            ...
                            <div class="row">
                                ...
                                <form role="form" id="form_company_register" method="post" action="">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text" class="form-control" id="company_address"
                                               ...
                                               value="{$companyAddress}" required="required" minlength="2"
                                               maxlength="300">
                                    </div>

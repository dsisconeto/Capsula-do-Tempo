...
matricula mt;
    public Pagamento1(int idCliente) throws SQLException {
        initComponents();
    ...
    public void carregarCampos() throws SQLException{
      //String  dataS = config.dataDoOS();
      
        mt.selecionaPeloCliente(this.getIdCliente());
        dataDecadastroTxt.setText(mt.getDataCadastro());
        dataDovencimento.setText(config.dataDoProMes());
        valorDoPagamendo.setText(String.valueOf(mt.getValorDoPagamento()));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                .addGap(12, 12, 12)
                                .addComponent(pagamentoCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pagamento1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

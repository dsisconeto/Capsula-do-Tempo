...
public final class cosultarCliente extends javax.swing.JFrame {
    ...
    public cosultarCliente() {
        initComponents();
        carragar();
        try {
            URL te = this.getClass().getResource("/telas/res/icone_logo.png");
            Image icone = Toolkit.getDefaultToolkit().getImage(te);
            this.setIconImage(icone);
        } catch (Exception e) {
        }
    }

    public void carragar() {
        try {
            revista = new revista();
        } catch (SQLException ex) {
            Logger.getLogger(cosultarCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            cl = new cliente();
        } catch (SQLException ex) {
    ...
    private void initComponents() {
        ...
        setTitle("Colheita - Consultar Cliente");
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID:", "NOME:", "TELEFONE:", "EMAIL:", "ENDEREÇO:", "CLIENTE DESDE:", "SEXO"
            }
        ) {
        ...
        nome.setToolTipText("Nome do Client ou ID");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/telas/res/btn/user_edit.png"))); // NOI18N
        jButton2.setText("Editar");
        jButton2.setToolTipText("Editar um cliente selecionado");
        ...
        jButton2.setBounds(750, 180, 140, 40);

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/telas/res/btn/user_delete.png"))); // NOI18N
        jButton3.setText("Deletar");
        jButton3.setToolTipText("Deletar um cliente selecionado");
        ...
        jButton3.setBounds(750, 140, 140, 40);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            if (com == 0) {
                ...
                retona = cl.deletaCliente((int) id);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            new telas.editar.EditarCliente((int) id).setVisible(true);
            this.dispose();
        } catch (Exception e) {
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            new telas.cadastrar.castrarCliente().setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(cosultarCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
    ...
    public void carregarTebela(String consultar, int op) throws SQLException {
        ...
        switch (op) {
            case 1:
                ...
                res = cl.selecionaTodosClintes();
                break;
            // consultando um cliente por nome ou id   
            case 2:
                res = cl.consultar(consultar);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cosultarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                    ...
                    new cosultarCliente().setVisible(true);

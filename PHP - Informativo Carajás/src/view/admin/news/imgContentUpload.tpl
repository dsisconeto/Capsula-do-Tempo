...
<form id="form_news_content_img" role="form" method="post"
      action="/form/admin/noticia/imagem/conteudo/upload/"
...
<script src="/admin/js/page/news/imgContentUpload.js"></script>
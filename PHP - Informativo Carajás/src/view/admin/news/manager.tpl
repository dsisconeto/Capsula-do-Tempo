                    ...
                    <div class="box-header">
                        ...
                        {if $edit}
                            <div class="btn-group pull-right" role="group" aria-label="...">
                                {if $newsStatus == 1}
                                    <button onclick="News.updateStatus({$newsId}, 3, this)"
                                            class="btn btn-primary">
                                        Públicar
                                    </button>
                                {else}
                                    <button onclick="News.updateStatus({$newsId}, 1, this)"
                                            class="btn btn-primary">
                                        Despublicar
                                    </button>
                                {/if}
                    ...
                    <div class="box-body pad">
                        ...
                        <form role="form" id="form_news_post" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Titulo" class="form-control" name="news_title"
                                       id="news_title"
                                       value="{$newsTitle}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <iframe border="0" style="overflow-x: hidden; height: 250px; width: 100%; border: 0;"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" id="select_category" name="news_category" required="required">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control"
                                                ...
                                                {if $edit}
                                                    <option value="{$newsTagId}" selected="selected">{$newsTagName}</option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control"
                                                id="select_local" name="news_local_id">
                                            {if $edit}
                                                <option value="{$newsLocalId}">{$newsLocalName}</option>
                                                {foreach from=$newsLocalAll item=keyLocal}
                                                    {if $newsLocalId != $keyLocal.news_local_id}
                                                        <option value="{$keyLocal.news_local_id}">{$keyLocal.news_local_name}</option>
                                                    {/if}
                                                {/foreach}
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {if $edit}
                                            <input type="number" min="0" max="{$newsLocalCountMax}" class="form-control"
                                                   value="{$newsOrder}" id="news_order" name="news_order">
                                        {else}
                                            <input type="number" min="0" max="1" class="form-control"
                                                   value="" id="news_order" name="news_order">
                                        {/if}
                                    </div>
...
<script src="/admin/js/obj/News.js"></script>
<script src="/admin/js/page/news/manager.js"></script>

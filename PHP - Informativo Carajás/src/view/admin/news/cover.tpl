...
<div class="content-wrapper">
                ...
                <div class="box box-info">
                    <div class="box-header">
                        ...
                        <div class="btn-group pull-right" role="group" aria-label="...">
                            {if $newsStatus == 1}
                                <button onclick="News.updateStatus({$newsId}, 3, this)" class="btn btn-primary">
                                  Públicar
                                </button>
                            {else}
                                <button onclick="News.updateStatus({$newsId}, 1, this)" class="btn btn-primary">
                    Despublicar
                                </button>
                            {/if}
    ...
    <script src="/admin/js/page/news/cover.js"></script>

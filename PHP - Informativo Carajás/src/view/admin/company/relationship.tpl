        ...
        <div class="row">
                                ...
                                <form role="form" id="form_company_phones" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-5">
                                            <label>Fone:</label>
                                            <input type="text" class="form-control" placeholder="xxxxxxxx ou xxxxxxxxx"
                                                   id="company_phone"
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h2 class="box-title">{if  !$loginUserCompany}Cadastrar relação com Região:{else}Relação com Região{/if}</h2>
                    </div><!-- /.box-header -->
                    <div class="box-body pad">
...
<script src="/admin/js/page/company/relationship.js"></script>

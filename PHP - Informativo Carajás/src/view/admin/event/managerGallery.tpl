...
<div class="content-wrapper">
    <link href="/admin/css/page/event-gallery-upload.css" rel="stylesheet">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="btn-group btn-group-sm pull-right">
                            ...
                            {/if}
                            <button class="btn btn-primary" onclick="loadShared({$eventId});">
                                facebook shared
                            </button>
                    ...
                    <div class="box-body pad">
                        ...
                        <form role="form" id="form_event_gallery" method="post"
                              action="/form/event-gallery/?upload" enctype="multipart/form-data">
                            <div class="row">
...
<script src="/admin/js/page/event/managerGallery.js"></script>

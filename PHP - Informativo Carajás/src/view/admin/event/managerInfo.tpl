                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body pad">
                        <form role="form" id="form_event" method="post"
                              action="/form/evento/{if $edit}editar{else}cadastrar{/if}">
                            <div class="row">
                                {if $edit}
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" id="geo_region_id_city" name="geo_region_id_city"
                                        ...
                                        {if isset($geo_region_id_city)}
                                            <option value="{$geo_region_id_city}" selected="selected">{$geo_region_name_city}</option>
                                        {/if}
                                ...
                                <div class="form-group col-md-12 text-center">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="event_roof" id="inlineRadio1"
                                               {if $edit && $eventRoof == 1}checked{/if} value="1"> Vai ter cobertura
                                        de fotos
                                    </label>
...
<script src="/admin/js/obj/Event.js"></script>
<script src="/admin/js/page/event/manager.js"></script>

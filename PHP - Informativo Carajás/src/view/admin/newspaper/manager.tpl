                ...
                <div class="box box-info">
                    ...
                    <div class="box-header">
                        ...
                        <div class="btn-group  btn-group-sm pull-left">
                            ...
                            {if $edit}
                                <a href="/admin/impresso/paginas/{$newspaperId}/" class="btn btn-info">
                                    Páginas
                                </a>
                            {/if}
                        </div>
                    ...
                    <div class="box-body pad">
                        ...
                        <form role="form" id="form_newspaper_manager" method="post"
                              action="/form/admin/impresso/{if $edit}editar{else}cadastrar{/if}/" autocomplete="off">
                            {if $edit}
...
<script src="/admin/js/page/newspaper/manager.js"></script>
